            ...
            <div id={"topPage"} className={`headline full-height d-flex flex-column align-items-center`}>
                ...
                <div
                    ...
                    <div className={"d-flex flex-column w-100 align-items-center"}>
                        <ReactArcText text={"THOMAS GARCIA - WEB DEVELOPER"} direction={1} arc={290}
                                      class={"eurostile text-red"}/>
                ...
                <div className={"design-statement"}>
                    <div>
                        <ScrollAnimation animateIn={"fadeInRight"}>
                            Hello I’m Thomas, web developer/UX Designer, I’m 21 years old and, have been developing for
                            the last 6 years.
                        </ScrollAnimation>
                    </div>
                    <div>
                        <ScrollAnimation animateIn={"fadeInLeft"}>
                            During my past experiences I could realize the lack of communication between the design and
                            development teams who unfortunately understand each other very poorly.
                        </ScrollAnimation>
                    </div>
                    <div>
                        <ScrollAnimation animateIn={"fadeInRight"}>
                            Indeed, as a developer I wanted to study design in order to connect these two worlds. My
                            experience as a developer allows me to know what is feasible or not when creating a design,
                            I guide my choices in order to obtain a convincing design while saving time to the
                            developers.
                        </ScrollAnimation>
                    </div>
                </div>
